...
INSERT INTO delivery_types (`id_formy_dostawy`, `nazwa`, `cena`) VALUES
(1, 'Kurier DPD', '5.00'),
...
ALTER TABLE orders
  ...
  ADD CONSTRAINT `zamowienia_ibfk_3` FOREIGN KEY (`id_formy_dostawy`) REFERENCES delivery_types (`id_formy_dostawy`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
