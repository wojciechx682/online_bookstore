<?php
	...
	if((!isset($_POST['login'])) || (!isset($_POST['haslo'])))
	{
		...
		// Sprawdź, czy istnieje w BD taki user,
		//          czy podano poprawne hasło

			// jeśli nie udało się zalogować -> przekieruj do index.php + wyświetl komunikat
			// jeśli udało się zalogować     -> przekieruj do index.php
