...
/*if(isset($_POST["adv-search-category"]) && !empty($_POST["adv-search-category"])) {
    ...
    echo "<br> kat -> " . $_SESSION["kategoria"] . "<br>"; exit();
}*/
...
<div id="container">
    ...
    <main>
        ...
        <aside id="book-filters">
            ...
            <div id="nav" style="overflow: auto;">
                ...
                <?php
                    query("SELECT DISTINCT imie, nazwisko, id_autora FROM author", "get_authors", ""); // lista <ul> autorów
                ?>
...
//                            }
                    ...
                    echo '<script> displayNav(); </script>';
                        ...
                        query("SELECT ks.id_ksiazki, ks.image_url, ks.tytul, ks.cena, ks.rok_wydania, ks.rating, 
                                     kt.nazwa, sb.id_kategorii, 
                                        au.imie, au.nazwisko 
                                     FROM books AS ks, author AS au, categories AS kt, subcategories AS sb 
        ...
        if(isset($_GET['wyrazenie']) && !empty($_GET['wyrazenie']) && isset($_GET['metoda']) && !empty($_GET['metoda']))
        {
            ...
            if($metoda == "autor")
            {
                ...
                query("SELECT id_ksiazki, author.id_autora, tytul, cena, rok_wydania, kategoria FROM books, author WHERE books.id_autora = author.id_autora AND (author.imie = '%s' OR author.nazwisko = '%s')", "advanced_search", $values);
