                ...
                <aside id="book-filters">
                    ...
                    <div id="nav" class="nav-visible">
                        ...
                        <div id="input-search-nav-div">
                            ...
                            <form action="../user/index.php" method="get"> <!-- (szukaj tytułu w tej kategorii) -->
                        ...
                        <?php
                            query("SELECT DISTINCT imie, nazwisko, id_autora FROM author", "get_authors", ""); // <ul> authors list;
                        ?>
