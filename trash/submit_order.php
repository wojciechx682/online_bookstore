	...
	<div id="container">
        ...
        <main>
            ...
            <div id="content">
                ...
                <?php
                    query("SELECT kl.id_klienta, ko.id_ksiazki, ko.ilosc, ks.tytul, ks.cena, ks.rok_wydania FROM customers AS kl, shopping_cart AS ko, books AS ks WHERE kl.id_klienta = ko.id_klienta AND ko.id_ksiazki = ks.id_ksiazki AND kl.id_klienta='%s'", "get_product_from_cart", $_SESSION['id']);
                ?>
