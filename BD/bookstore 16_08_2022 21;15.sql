...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Sie 2022, 21:15
...
CREATE TABLE `klienci` (
  ...
  `numer_domu` varchar(10) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `kod_pocztowy` varchar(7) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  ...
  `telefon` varchar(15) COLLATE utf8mb4_polish_ci DEFAULT NULL,
...
(1, 'Adam', 'Wojciechowski', 'Smolnica', '--', '67/4', '74-400', 'Dębno', 'Zachodniopomorskie', 'Polska', '99082807355', '0000-00-00', '515350960', 'jason1@wp.com', 'jason1', '$2y$10$d393AdfNZVsEvyNFynblPOLr1AhZpAuAdXl.hmDcxgm.ANXh4xuWG'),
...
(6, 'Stefan', 'Żyromski', 'Czechociny', 'Studniowa', '15', '45-640', 'Szczecinek', 'Czechosłowackie', 'Chiny', '00273827351', '0000-00-00', '530938222', 'stefan2@wp.pl', 'stefan2', '$2y$10$7o7B0nLjcv60H84mvDJqKeXLn3lz5ahf8kPEjhw0c05fWbu2YLYtG'),
