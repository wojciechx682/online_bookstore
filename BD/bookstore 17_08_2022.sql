...
--
-- Host: 127.0.0.1
-- Czas generowania: 17 Sie 2022, 23:31
...
(1, 'Jakub', 'Wojciechowski', 'Smolnica', '--', '67/4', '74-400', 'Dębno', 'Zachodniopomorskie', 'Polska', '99082807355', '0000-00-00', '515350960', 'jason1@wp.pl', 'jason1', '$2y$10$w4NvNJaNKjMHxxtSoWJ46.1LhKo2hkr1bWKp0vMSNe00RuTZjDhkC'),
...
--
ALTER TABLE `platnosci`
  MODIFY `id_platnosci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT dla tabeli `zamowienia`
--
ALTER TABLE `zamowienia`
  MODIFY `id_zamowienia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
