...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Sie 2022, 16:58
...
CREATE TABLE `autor` (
  ...
  `narodowosc` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `okres_tworczosci` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `rodzaj_tworczosci` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL
...
CREATE TABLE `klienci` (
  ...
  `miejscowosc` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `ulica` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `numer_domu` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `kod_pocztowy` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `kod_miejscowosc` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `wojewodztwo` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `kraj` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `PESEL` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `data_urodzenia` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `telefon` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
...
(1, 'Adam', 'Wojciechowski', 'Smolnica', '--', '67/4', '74-400', 'Dębno', 'Zachodniopomorskie', 'Polska', '99082807355', '28-08-1999', '515350960', 'jason1@wp.com', 'jason1', '$2y$10$d393AdfNZVsEvyNFynblPOLr1AhZpAuAdXl.hmDcxgm.ANXh4xuWG'),
(3, 'Tomas', 'Edison', 'abcde', 'fghi', 'jklm', '12', 'Dębno', 'asd', 'PL', 'asd', '28082888', '123123123', 'tomas1@wp.pl', 'Tomas111', '$2y$10$wHoW1LjwjDESsTV0JwWkOOYLesP/c4OUV1.emGsA35j3U57jFdk5O'),
(5, 'Adam', 'Kowalski', 'Smolnica', '54', '13', '74-400', 'Dębno', 'Zachodniopomorskie', 'Polska', '11121314150', '1975-16-08', '505 422 309', 'adam_kowal@wp.pl', 'adam3000', '$2y$10$dY1J2B9nFjF6mPdFOV8uQOla/CF2U//IzCuXrHswrWqCC228b8kU2'),
(6, 'Stefan', 'Żyromski', 'Czechociny', 'Studniowa', '15', '45-640', 'Szczecinek', 'Czechosłowackie', 'Chiny', '00273827351', '01-01-2000', '530938222', 'stefan2@wp.pl', 'stefan2', '$2y$10$7o7B0nLjcv60H84mvDJqKeXLn3lz5ahf8kPEjhw0c05fWbu2YLYtG'),
(7, 'Hubert', 'Zmysłowski', 'Gorzów', 'Kaliszowa', '59', '34-130', 'Gorzów Wielkopolski', 'Zachodniopomorskie', 'Polska', '99082807355', '28-08-1999', '827938192', 'hubert61312@wp.pl', 'hubert1', '$2y$10$CmV0gCewin/EhtrHN5JL7.Ls2wCt.5Ft0I4b5efvRTM95sN6uj1J.');
...
CREATE TABLE `ksiazki` (
  `id_ksiazki` int(11) NOT NULL,
  `id_autora` int(11) NOT NULL,
  `tytul` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `cena` float DEFAULT NULL,
  `rok_wydania` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `kategoria` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `oprawa` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
...
CREATE TABLE `magazyn` (
  ...
  `wojewodztwo` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  ...
  `kod_pocztowy` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `kod_miejscowosc` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
...
CREATE TABLE `magazyn_ksiazki` (
  `id_magazynu` int(11) NOT NULL,
  `id_ksiazki` int(11) NOT NULL,
  `ilosc_dostepnych_egzemplarzy` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
...
CREATE TABLE `platnosci` (
  ...
  `data_platnosci` varchar(11) COLLATE utf8mb4_polish_ci NOT NULL,
  `kwota` float NOT NULL,
  `sposob_platnosci` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
...
(64, 67, '16-08-2022 ', 587.63, 'Blik'),
(65, 68, '16-08-2022 ', 1107.54, 'Pobranie');
...
CREATE TABLE `wydawcy` (
  `id_wydawcy` int(11) NOT NULL,
  `nazwa_wydawcy` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
...
CREATE TABLE `zamowienia` (
  ...
  `data_zlozenia_zamowienia` varchar(255) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `termin_dostawy` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `data_wysłania_zamowienia` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `data_dostarczenia` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `forma_dostarczenia` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
...
(67, 1, '16-08-2022 16:52', '21-08-2022 16:52', '17-08-2022 16:52', '21-08-2022 16:52', 'Kurier DPD', 'Wysłano'),
(68, 1, '16-08-2022 16:55', '21-08-2022 16:55', '17-08-2022 16:55', '21-08-2022 16:55', 'Paczkomaty 24/7 - Inpost', 'W trakcie realizacji');
...
--
ALTER TABLE `ksiazki`
  MODIFY `id_ksiazki` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT dla tabeli `platnosci`
--
ALTER TABLE `platnosci`
  MODIFY `id_platnosci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT dla tabeli `zamowienia`
--
ALTER TABLE `zamowienia`
  MODIFY `id_zamowienia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
