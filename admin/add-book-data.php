...
require_once "../authenticate-admin.php";
    ...
    if (
        ...
        query("SELECT id_autora FROM authors ORDER BY id_autora DESC LIMIT 1", "getAuthorId", ""); // get highest author-id from db;
        ...
        query("SELECT id_magazynu FROM warehouse ORDER BY id_magazynu DESC LIMIT 1", "getMagazineId", ""); // get highest magazine-id from db;
            ...
            query("SELECT id_autora FROM authors WHERE id_autora = '%s'", "verifyAuthorExists", $author);
