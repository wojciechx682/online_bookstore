<?php
    ...
    if (isset($_SESSION["password_confirmed"]) && $_SESSION["password_confirmed"] ) { // podano poprawne hasło;
        ...
        query("DELETE FROM customers WHERE id_klienta='%s'", "", $_SESSION["id"]);
                            ...
                            <div class="edit_data_container remove_account">
                                ...
                                <div class="edit_data_right-container">
                                        ...
                                        <div class="edit_data_right">
                                            <?= empty($_SESSION["ulica"]) ? ($_SESSION["miejscowosc"]. ", " . $_SESSION["numer_domu"] . " ") : ($_SESSION["miejscowosc"].", ul. " . $_SESSION["ulica"] . " " . $_SESSION["numer_domu"]); ?>
