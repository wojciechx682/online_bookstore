	...
	<div id="container">
		...
		<div id="top-nav">
			...
			<div id="div_log_in">
				...
				<a class="top-nav-right" href="../user/zaloguj.php">Zaloguj</a>

			</div>

			<div id="div_register">
				
				<a class="top-nav-right" href="../user/rejestracja.php">Zarejestruj</a>
				
			</div>

			<div id="div_cart">
				
				<a class="top-nav-right" href="../user/koszyk.php">Koszyk</a>
			...
			<div id="div_my_account">
				...
				<a class="top-nav-right" href="../user/account.php">Moje konto</a>
